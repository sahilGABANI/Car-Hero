...
class CarWashViewItem(context: Context) : ConstraintLayoutWithLifecycle(context) {
    private lateinit var dataVideo: CarWashDetailsInfo
    ...
    fun bind(dataVideo: CarWashDetailsInfo) {
